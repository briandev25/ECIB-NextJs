...
const dispatch = useDispatch();
  ...
  return (
    <div className='flex bg-white'>
        {/* image */}
        <div className='relative h-24 w-40 md:h-[200px] md:w-[300px]' >
        ...
        <div className='flex flex-col flex-grow flex-1 p-4'>
           <div className='flex justify-between whitespace-nowrap'>
              ...
              {liked ? <HeartIconSolid onClick={() => setLiked(false)} className='h-7 text-red-600 cursor-pointer' /> : <HeartIconOutline onClick={() => setLiked(true)} className='h-7 cursor-pointer text-black' />}
           </div>
