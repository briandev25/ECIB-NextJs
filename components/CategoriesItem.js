...
function CategoriesItem() {
  return (
      <div data-aos="fade-up" className='flex my-10 xl:mx-20 space-x-10 overflow-x-scroll scrollbar-hide'>
       {categories.map(({image,name}) =>(
          <div className='px-2 lg:p-10 flex flex-col items-center cursor-pointer' key={image}>
